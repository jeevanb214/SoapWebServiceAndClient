...
<jsp:useBean id="sampleSoapServiceProxyid" scope="session" class="com.jeevan.SoapServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        com.jeevan.SoapService getSoapService10mtemp = sampleSoapServiceProxyid.getSoapService();
...
case 13:
        ...
        int add13mtemp = sampleSoapServiceProxyid.add(a_1idTemp,b_2idTemp);
