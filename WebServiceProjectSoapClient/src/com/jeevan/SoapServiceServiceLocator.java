...
public class SoapServiceServiceLocator extends org.apache.axis.client.Service implements com.jeevan.SoapServiceService {
    ...
    private java.lang.String SoapService_address = "http://localhost:8005/WebServiceProjectSoap/services/SoapService";
    ...
    public com.jeevan.SoapService getSoapService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jeevan.SoapServiceSoapBindingStub _stub = new com.jeevan.SoapServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jeevan.SoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jeevan.SoapServiceSoapBindingStub _stub = new com.jeevan.SoapServiceSoapBindingStub(new java.net.URL(SoapService_address), this);
                _stub.setPortName(getSoapServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jeevan.com", "SoapServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jeevan.com", "SoapService"));
        }
